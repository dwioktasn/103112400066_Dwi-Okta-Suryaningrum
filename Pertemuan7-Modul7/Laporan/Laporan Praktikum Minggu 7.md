...
## Unguided
___
#### 1. Tambahkan prosedur pushAscending( in/out S : Stack, in x : integer
```C++
file stack.cpp
#include "stack.h"
using namespace std;
...
#### 2. Tambahkan prosedur getInputStream( in/out S : Stack ). Prosedur akan terus membaca dan menerima input user dan memasukkan setiap input ke dalam stack hingga user menekan tombol enter.
